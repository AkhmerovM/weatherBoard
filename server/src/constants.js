...
export const cities = [
    ...
    { coord: { lon: 30.2642, lat: 59.8944 }, weather: [{ id: 804, main: 'Snow', description: 'overcast clouds', icon: '04d' }], base: 'stations', main: { temp: 11.12, feels_like: 10.09, temp_min: 11.08, temp_max: 13.39, pressure: 1018, humidity: 69 }, visibility: 9000, wind: { speed: 6, deg: 260 }, clouds: { all: 100 }, dt: 1662205223, sys: { type: 2, id: 197864, country: 'RU', sunrise: 1662173910, sunset: 1662224324 }, timezone: 10800, id: 498817, name: 'Saint Petersburg', cod: 200 },
